...
SELECT baninst1.mc_fa_budget.get_grad_intensive_board(rzvpbgp_aidy_code, 'ART') * COUNT(sfrstcr_crn)
FROM rzvpbgp
LEFT JOIN sfrstcr
...
SELECT baninst1.mc_fa_budget.get_grad_intensive_board(rzvpbgp_aidy_code, 'DEFAULT') * COUNT(sfrstcr_crn)
FROM rzvpbgp
LEFT JOIN sfrstcr
  ON rzvpbgp_pidm = sfrstcr_pidm
  AND rzvpbgp_term_code = sfrstcr_term_code
